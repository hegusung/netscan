...
def main():
    parser = argparse.ArgumentParser(description='VNCScan', formatter_class=ColoredSelectiveDefaultsHelpFormatter)
    ...
    if args.bruteforce:
        actions['bruteforce'] = {'password_file': normalize_path(args.password_file)}
