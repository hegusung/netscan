...
def main():
    ...
    httpscan(targets, static_inputs, args.verb, args.data, args.workers, actions, args.useragent, header_dict, args.http_auth, cookie_dict, args.proxy, normalize_path(args.dir_bruteforce), args.extensions, args.dir_bruteforce_workers, args.timeout, args.delay, args.resume)

    DB.stop_worker()
    Output.stop()


def httpscan(input_targets, static_inputs, verb, data, workers, actions, useragent, header_dict, http_auth, cookie_dict, proxy, dir_bruteforce, extensions, dir_bruteforce_workers, timeout, delay, resume):
    args = (verb, data, actions, useragent, header_dict, http_auth, cookie_dict, proxy, dir_bruteforce, extensions, dir_bruteforce_workers, timeout)
